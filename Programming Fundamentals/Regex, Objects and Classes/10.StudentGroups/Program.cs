    ...
    class Program
    {
        ...
        public static List<Town> ReadTownsAndStudents()
        {
            ...
            while (!input.Equals("End"))
            {
                ...
                {
                    string[] studentNameEmailDate =
                        input.Split(new char[] { ' ', '|' }, StringSplitOptions.RemoveEmptyEntries);
                    Student currentStudent =
                        new Student
                        {
                            Name = studentNameEmailDate[0] + ' ' + studentNameEmailDate[1],
                            Email = studentNameEmailDate[2],
                            RegistrationDate = DateTime.ParseExact(studentNameEmailDate[3], "d-MMM-yyyy", null)
                        };
